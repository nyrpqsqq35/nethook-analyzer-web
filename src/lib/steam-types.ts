...
function createEnum(nameToKey: SEnum['nameToKey']): SEnum {
  const e: SEnum = {
    nameToKey,
    keyToName: Object.fromEntries(Object.entries(nameToKey).map(([k, v]) => [v, k])),
  }
  return e
}

export const EMsg_Enum = createEnum({
  Invalid: 0,
  Multi: 1,
  ProtobufWrapped: 2,
  BaseGeneral: 100,
...
export const EResult_Enum = createEnum({
  Invalid: 0,
  OK: 1,
  Fail: 2,
  NoConnection: 3,
